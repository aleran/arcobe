...
$conexion=mysql_connect("localhost","root","12345678956") or die (mysql_error());
mysql_select_db("cj_pv",$conexion) or die (mysql_error());

$search = $_POST['cedula'];
$query_services = mysql_query("SELECT * FROM cj_trabajadores_institutos WHERE trb_cedula like '" . $search . "%' and trb_cedula!='' ORDER BY trb_cedula DESC", $conexion);
