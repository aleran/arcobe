...
$cj_hijosSQL = "SELECT * FROM pv_planilla WHERE pv_destino='$tipo' ORDER BY pv_fechainscri";
...
header('Content-Disposition: attachment; filename="PlanVacacional ('.$tipo.').xlsx"');
